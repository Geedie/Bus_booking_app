...
public:
    ...
    map<string, double> getTienIch() const { return tienIch; }

    void setBienSo(const string& bienSo) { this->bienSo = bienSo; }
    void setLoaiXe(const string& loaiXe) { this->loaiXe = loaiXe; }
    void setSoChoNgoi(int soChoNgoi) { this->soChoNgoi = soChoNgoi; }
    void setTienIch(const map<string, double>& tienIch) { this->tienIch = tienIch; }
};
